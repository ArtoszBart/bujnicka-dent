		...
		<main className='page-wrapper' role='main'>
			...
			<article className='page-content'>
				...
				<TabContent id={0} activeTab={activeTab}>
					...
					<SinglePrice name='Znieczulenie (również na życzenie pacjenta)' price='50 zł' />
				</TabContent>

				<TabContent id={1} activeTab={activeTab}>
					<h2>Profilaktyka</h2>
					<SinglePrice name='Scaling i likwidacja osadu (higienizacja)' price='150-400 zł' />
				...
				<TabContent id={2} activeTab={activeTab}>
					...
					<MultiplePrices
						...
						prices={['250 zł', '200 zł', 'nowa cena']}
					/>
					<MultiplePrices title='Onlay lub Inlay' names={['Kompozytowy', 'Porcelanowy']} prices={['1000 zł', '1300 zł']} />
				...
				<TabContent id={3} activeTab={activeTab}>
					...
					<SinglePrice name='Leczenie biologiczne miazgi' price='260 zł' />
					<SinglePrice name='Wypełnienia (Plomby)' price='180-550 zł' />
					<MultiplePrices title='Onlay lub Inlay' names={['Kompozytowy', 'Porcelanowy']} prices={['1000 zł', '1300 zł']} />
				</TabContent>
				...
				<TabContent id={4} activeTab={activeTab}>
					...
					/>
					<aside>
						Cena leczenia kanałowego uzależniona jest od stopnia zaawansowania oraz przebiegu choroby. Powyższe ceny dotyczą
						leczenia bez powikłań.
					</aside>
				</TabContent>

				<TabContent id={5} activeTab={activeTab}>
					<h2>Periodontologia</h2>
					<SinglePrice name='Scaling i likwidacja osadu' price='150-400 zł' />
				...
				<TabContent id={6} activeTab={activeTab}>
					...
					<dd>
						***{' '}
						<span className='text-link' onClick={() => UseModal.openModal('Proteza bezklamrowa z zamkami typu CEKA')}>
